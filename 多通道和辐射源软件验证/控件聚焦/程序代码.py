...
class OneLineEdit(QLineEdit):
    ...
    def __init__(self, parent: QWidget, w: int, h: int, x: int, y: int, is_add_group: bool):
        super().__init__()
        self._is_edit = False
        # INIT
...
class OneSpinBox(QSpinBox):
    ...
    def __init__(self, parent: QWidget, w: int, h: int, x: int, y: int):
        super().__init__()
        self._is_edit = False
        # INIT
        self.setReadOnly(True)
...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        self._one_line2 = OneLineEdit(parent=self, w=200, h=30, x=20, y=70)
        self._one_spinbox = OneSpinBox(parent=self, w=200, h=30, x=20, y=120)
        self._group = Group()
        self._group.add_widget(self._one_line)
        self._group.add_widget(self._one_line2)
        self._one_line2.set_visible(False)
        self._group.add_widget(self._one_spinbox)
